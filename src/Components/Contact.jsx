    ...
    return (
        <section id='Contact' className="Contact">
            ...
            <div className='Contact-content'>
                <a href="https://instagram.com/caz.life" target='_blank' className="Contact-link" ><Instagram id='instagram' className='Contact-icon'  /></a>
                <a href="https://linkedin.com/in/claire-zen" target='_blank' className="Contact-link" ><LinkedIn id='linkedin' className='Contact-icon' /></a>
