...
const DropDown = () => {
    return (
        <div className="About-DropDown">
            ...
            <p className="About-description">In her spare time, Claire is designing a Star Wars DnD campaign at home with her cat Ahsoka. When she’s out and about, Claire is hunting for the best Cubano sandwich or looking out for the prettiest cloud.
</p>
